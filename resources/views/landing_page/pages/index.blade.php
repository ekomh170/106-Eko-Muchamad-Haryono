            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        ...
                        <p class="mb-4">ApoTrack adalah sebuah aplikasi berbasis web yang dirancang khusus untuk mengelola
                            sebuah apotik. Sistem Informasi apotik dalam mengelola inventaris obat, transaksi penjualan, dan
                            manajemen data pelanggan.</p>
                        <p><a href="{{ url('login') }}" class="btn btn-secondary me-2">Login Petugas</a><a
                                href="{{ url('services') }}" class="btn btn-white-outline">Layanan & Obat</a></p>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="hero-img-wrap">
                        <img src="{{ asset('assets/landing_page/images/desain/apotik.png') }}" class="img-fluid"
                            style="width: 600px">
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    ...
                    <p class="mb-4">Kami menyediakan berbagai macam obat-obatan berkualitas untuk kebutuhan kesehatan
                        Anda. Temukan produk terbaik dengan harga terjangkau.</p>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="{{ url('cart') }}">
                        <img src="{{ asset('assets/landing_page/images/obat/paracetamol-box-1.png') }}"
                            class="img-fluid product-thumbnail" style="max-width: 100%; height: auto;">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="{{ url('cart') }}">
                        <img src="{{ asset('assets/landing_page/images/obat/panadol.jpg') }}"
                            class="img-fluid product-thumbnail" style="max-width: 100%; height: auto;">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="{{ url('cart') }}">
                        <img src="{{ asset('assets/landing_page/images/obat/Ibuprofen.jpg') }}"
     class="img-fluid product-thumbnail" style="max-width: 100%; height: 300px;">
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    ...
                    <p>Kami menyediakan layanan terbaik untuk memastikan kesehatan Anda tetap terjaga. Berikut beberapa
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/landing_page/images/obat/paracetamol-box-1.png') }}" alt="Image"
                                class="img-fluid">
                        </div>
                        <div class="pt-3">
                            <h3>Paracetamol</h3>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/landing_page/images/obat/amoxicillin.jpg') }}" alt="Image"
                                class="img-fluid">
                        </div>
                        <div class="pt-3">
                            <h3>Amoxicillin</h3>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/landing_page/images/obat/vitamin_c.jpg') }}" alt="Image"
                                class="img-fluid">
                        </div>
                        <div class="pt-3">
                            <h3>Vitamin C</h3>
