        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsFurni">
                <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <li><a class="nav-link" href="{{ url('about') }}">Tentang</a></li>
                    <li><a class="nav-link" href="{{ url('services') }}">Layanan & Obat</a></li>
                    <li><a class="nav-link" href="{{ url('contact') }}">Kontak</a></li>
                    <li><a class="nav-link" href="{{ url('login')}}">Petugas Login</a></li>
                </ul>
            </div>
        </div>
