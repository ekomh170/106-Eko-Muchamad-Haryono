                        ...
                        <tbody>
                            @foreach($metodePembayaran as $index => $metode)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('MetodePembayaran.show', $metode->id_metode_pembayaran) }}" class="btn btn-info btn-sm">
                                            <i class="fa fa-eye"></i> Lihat
                                        </a>
                                        <a href="{{ route('MetodePembayaran.edit', $metode->id_metode_pembayaran) }}" class="btn btn-warning btn-sm">
                                            <i class="fa fa-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('MetodePembayaran.destroy', $metode->id_metode_pembayaran) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
