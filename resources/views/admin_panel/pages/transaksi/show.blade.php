            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <div class="card bg-dark text-white border border-2 border-light">
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        <a href="{{ route('Pelanggan.edit', $transaksi->id_pelanggan) }}" class="btn btn-warning btn-sm me-2">
                            <i class="fa fa-edit"></i> Edit
                        </a>
                        <form action="{{ route('Pelanggan.destroy', $transaksi->id_pelanggan) }}" method="POST" style="display:inline-block;">
                            @csrf
                            @method('DELETE')
